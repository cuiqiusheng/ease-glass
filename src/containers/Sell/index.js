...
const columns = [
  ...
  { title: '顾客姓名', dataIndex: 'c' },
  { title: '销售门店', dataIndex: 'd' },
  { title: '取镜门店', dataIndex: 'e' },
  { title: '状态', dataIndex: 'f' },
  { title: '销售时间', dataIndex: 'g' },
    ...
    return (
      <div className={style.wrapper}>
        <div className={classnames('clearfix', 'content-header')}>
          <div className={classnames('fl')}>配镜单</div>
