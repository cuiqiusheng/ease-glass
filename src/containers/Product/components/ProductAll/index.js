...
const columns = [
  ...
  { title: '产品代码', dataIndex: 'c' },
  { title: '产品类别', dataIndex: 'd' },
  { title: '供应商', dataIndex: 'e' },
    ...
    return (
      <div className={style.wrapper}>
        <div className={classnames('clearfix', 'content-header')}>
          <div className={classnames('fl')}>所有产品</div>
...
ProductAll.propTypes = propTypes

const ProductAllForm = Form.create()(ProductAll)
